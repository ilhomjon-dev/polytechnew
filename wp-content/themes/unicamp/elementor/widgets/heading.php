...
class Widget_Heading extends Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Heading', 'unicamp' );
	}
	...
	private function add_title_section() {
		...
		$this->add_control( 'title', [
			...
			'description' => esc_html__( 'Wrap any words with &lt;mark&gt;&lt;/mark&gt; tag to make them highlight.', 'unicamp' ),
		] );
		...
		$this->add_control( 'title_link_animate', [
			'label'        => esc_html__( 'Link Animate', 'unicamp' ),
			'type'         => Controls_Manager::SELECT,
			'options'      => [
				''                  => esc_html__( 'None', 'unicamp' ),
				'animate-border'    => esc_html__( 'Animate Border', 'unicamp' ),
				'animate-border-02' => esc_html__( 'Animate Border 02', 'unicamp' ),
			],
			'default'      => '',
			'prefix_class' => 'unicamp-link-',
		] );
		...
		$this->add_control( 'title_style', [
			...
			'options'      => [
				''   => esc_html__( 'None', 'unicamp' ),
				'01' => esc_html__( 'Curve on mark tag', 'unicamp' ),
				'02' => esc_html__( 'Underline on mark tag', 'unicamp' ),
				'03' => esc_html__( 'Underline Zigzag on mark tag', 'unicamp' ),
				'04' => esc_html__( 'Thick Underline on mark tag', 'unicamp' ),
			],
			'default'      => '',
			'prefix_class' => 'unicamp-modern-heading-style-',
		] );
	...
	private function add_sub_title_section() {
		$this->start_controls_section( 'sub_title_section', [
			'label' => esc_html__( 'Secondary Heading', 'unicamp' ),
		] );
	...
	private function add_title_style_section() {
		...
		$this->add_control( 'highlight_heading', [
			'label'     => esc_html__( 'Highlight Words', 'unicamp' ),
	...
	private function add_divider_style_section() {
		$this->start_controls_section( 'divider_style_section', [
			'label'     => esc_html__( 'Divider', 'unicamp' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'divider_enable' => 'yes',
			],
